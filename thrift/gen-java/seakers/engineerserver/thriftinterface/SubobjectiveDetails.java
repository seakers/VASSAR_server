...
public class SubobjectiveDetails implements org.apache.thrift.TBase<SubobjectiveDetails, SubobjectiveDetails._Fields>, java.io.Serializable, Cloneable, Comparable<SubobjectiveDetails> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> attr_names; // required
  public @org.apache.thrift.annotation.Nullable java.util.List<java.util.List<java.lang.String>> attr_values; // required
  public @org.apache.thrift.annotation.Nullable java.util.List<java.lang.Double> scores; // required
  public @org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> taken_by; // required
  public @org.apache.thrift.annotation.Nullable java.util.List<java.util.List<java.lang.String>> justifications; // required
  ...
  public SubobjectiveDetails setParam(@org.apache.thrift.annotation.Nullable java.lang.String param) {
    this.param = param;
    return this;
  }
  ...
  public SubobjectiveDetails setAttr_names(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> attr_names) {
    this.attr_names = attr_names;
    return this;
  }
  ...
  public SubobjectiveDetails setAttr_values(@org.apache.thrift.annotation.Nullable java.util.List<java.util.List<java.lang.String>> attr_values) {
    this.attr_values = attr_values;
    return this;
  }
  ...
  public SubobjectiveDetails setScores(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.Double> scores) {
    this.scores = scores;
    return this;
  }
  ...
  public SubobjectiveDetails setTaken_by(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> taken_by) {
    this.taken_by = taken_by;
    return this;
  }
  ...
  public SubobjectiveDetails setJustifications(@org.apache.thrift.annotation.Nullable java.util.List<java.util.List<java.lang.String>> justifications) {
    this.justifications = justifications;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.attr_names = new java.util.ArrayList<java.lang.String>(_list94.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _elem95;
                for (int _i96 = 0; _i96 < _list94.size; ++_i96)
                {
                  _elem95 = iprot.readString();
                  struct.attr_names.add(_elem95);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.attr_values = new java.util.ArrayList<java.util.List<java.lang.String>>(_list97.size);
                @org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> _elem98;
                for (int _i99 = 0; _i99 < _list97.size; ++_i99)
                {
                  {
                    org.apache.thrift.protocol.TList _list100 = iprot.readListBegin();
                    _elem98 = new java.util.ArrayList<java.lang.String>(_list100.size);
                  ...
                  struct.attr_values.add(_elem98);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.scores = new java.util.ArrayList<java.lang.Double>(_list103.size);
                double _elem104;
                for (int _i105 = 0; _i105 < _list103.size; ++_i105)
                {
                  _elem104 = iprot.readDouble();
                  struct.scores.add(_elem104);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.taken_by = new java.util.ArrayList<java.lang.String>(_list106.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _elem107;
                for (int _i108 = 0; _i108 < _list106.size; ++_i108)
                {
                  _elem107 = iprot.readString();
                  struct.taken_by.add(_elem107);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.justifications = new java.util.ArrayList<java.util.List<java.lang.String>>(_list109.size);
                @org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> _elem110;
                for (int _i111 = 0; _i111 < _list109.size; ++_i111)
                {
                  {
                    org.apache.thrift.protocol.TList _list112 = iprot.readListBegin();
                    _elem110 = new java.util.ArrayList<java.lang.String>(_list112.size);
                  ...
                  struct.justifications.add(_elem110);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SubobjectiveDetails struct) throws org.apache.thrift.TException {
      ...
      if (struct.attr_names != null) {
        oprot.writeFieldBegin(ATTR_NAMES_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter115 : struct.attr_names)
          {
      ...
      if (struct.scores != null) {
        oprot.writeFieldBegin(SCORES_FIELD_DESC);
        {
          ...
          for (double _iter118 : struct.scores)
          {
      ...
      if (struct.taken_by != null) {
        oprot.writeFieldBegin(TAKEN_BY_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter119 : struct.taken_by)
          {
      ...
      if (struct.isSetAttr_names()) {
        {
          ...
          for (java.lang.String _iter122 : struct.attr_names)
          {
      ...
      if (struct.isSetAttr_values()) {
        {
          ...
          for (java.util.List<java.lang.String> _iter123 : struct.attr_values)
          {
            {
              oprot.writeI32(_iter123.size());
              for (java.lang.String _iter124 : _iter123)
              {
      ...
      if (struct.isSetScores()) {
        {
          ...
          for (double _iter125 : struct.scores)
          {
            oprot.writeDouble(_iter125);
          }
        }
      }
      if (struct.isSetTaken_by()) {
        {
          ...
          for (java.lang.String _iter126 : struct.taken_by)
          {
      ...
      if (struct.isSetJustifications()) {
        {
          ...
          for (java.util.List<java.lang.String> _iter127 : struct.justifications)
          {
            {
              oprot.writeI32(_iter127.size());
              for (java.lang.String _iter128 : _iter127)
              {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.attr_names = new java.util.ArrayList<java.lang.String>(_list129.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _elem130;
          for (int _i131 = 0; _i131 < _list129.size; ++_i131)
          {
            _elem130 = iprot.readString();
            struct.attr_names.add(_elem130);
          }
        }
        struct.setAttr_namesIsSet(true);
      }
      if (incoming.get(2)) {
        {
          ...
          struct.attr_values = new java.util.ArrayList<java.util.List<java.lang.String>>(_list132.size);
          @org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> _elem133;
          ...
          {
            {
              ...
              _elem133 = new java.util.ArrayList<java.lang.String>(_list135.size);
            ...
            struct.attr_values.add(_elem133);
          }
        }
        struct.setAttr_valuesIsSet(true);
      }
      if (incoming.get(3)) {
        {
          ...
          struct.scores = new java.util.ArrayList<java.lang.Double>(_list138.size);
          double _elem139;
          for (int _i140 = 0; _i140 < _list138.size; ++_i140)
          {
            _elem139 = iprot.readDouble();
            struct.scores.add(_elem139);
          }
        }
        struct.setScoresIsSet(true);
      }
      if (incoming.get(4)) {
        {
          ...
          struct.taken_by = new java.util.ArrayList<java.lang.String>(_list141.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _elem142;
          for (int _i143 = 0; _i143 < _list141.size; ++_i143)
          {
            _elem142 = iprot.readString();
            struct.taken_by.add(_elem142);
          }
        }
        struct.setTaken_byIsSet(true);
      }
      if (incoming.get(5)) {
        {
          ...
          struct.justifications = new java.util.ArrayList<java.util.List<java.lang.String>>(_list144.size);
          ...
          for (int _i146 = 0; _i146 < _list144.size; ++_i146)
          {
            ...
            struct.justifications.add(_elem145);
          }
        }
        struct.setJustificationsIsSet(true);
      }
