...
public class DiscreteInputArchitecture implements org.apache.thrift.TBase<DiscreteInputArchitecture, DiscreteInputArchitecture._Fields>, java.io.Serializable, Cloneable, Comparable<DiscreteInputArchitecture> {
  ...
  public DiscreteInputArchitecture setInputs(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.Integer> inputs) {
    this.inputs = inputs;
    return this;
  }
  ...
  public DiscreteInputArchitecture setOutputs(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.Double> outputs) {
    this.outputs = outputs;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.inputs = new java.util.ArrayList<java.lang.Integer>(_list16.size);
                int _elem17;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.outputs = new java.util.ArrayList<java.lang.Double>(_list19.size);
                double _elem20;
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.inputs = new java.util.ArrayList<java.lang.Integer>(_list26.size);
          int _elem27;
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.outputs = new java.util.ArrayList<java.lang.Double>(_list29.size);
          double _elem30;
