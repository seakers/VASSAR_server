...
public class MissionCostInformation implements org.apache.thrift.TBase<MissionCostInformation, MissionCostInformation._Fields>, java.io.Serializable, Cloneable, Comparable<MissionCostInformation> {
  ...
  public java.lang.String orbit_name; // required
  public java.util.List<java.lang.String> payload; // required
  public java.lang.String launch_vehicle; // required
  public double total_mass; // required
  public double total_power; // required
  public double total_cost; // required
  public java.util.Map<java.lang.String,java.lang.Double> mass_budget; // required
  public java.util.Map<java.lang.String,java.lang.Double> power_budget; // required
  public java.util.Map<java.lang.String,java.lang.Double> cost_budget; // required
  ...
  public MissionCostInformation setOrbit_name(java.lang.String orbit_name) {
    this.orbit_name = orbit_name;
    return this;
  }
  ...
  public MissionCostInformation setPayload(java.util.List<java.lang.String> payload) {
    this.payload = payload;
    return this;
  }
  ...
  public MissionCostInformation setLaunch_vehicle(java.lang.String launch_vehicle) {
    this.launch_vehicle = launch_vehicle;
    return this;
  }
  ...
  public MissionCostInformation setMass_budget(java.util.Map<java.lang.String,java.lang.Double> mass_budget) {
    this.mass_budget = mass_budget;
    return this;
  }
  ...
  public MissionCostInformation setPower_budget(java.util.Map<java.lang.String,java.lang.Double> power_budget) {
    this.power_budget = power_budget;
    return this;
  }
  ...
  public MissionCostInformation setCost_budget(java.util.Map<java.lang.String,java.lang.Double> cost_budget) {
    this.cost_budget = cost_budget;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.payload = new java.util.ArrayList<java.lang.String>(_list24.size);
                java.lang.String _elem25;
                for (int _i26 = 0; _i26 < _list24.size; ++_i26)
                {
                  _elem25 = iprot.readString();
                  struct.payload.add(_elem25);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.mass_budget = new java.util.HashMap<java.lang.String,java.lang.Double>(2*_map27.size);
                ...
                for (int _i30 = 0; _i30 < _map27.size; ++_i30)
                {
                  ...
                  struct.mass_budget.put(_key28, _val29);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.power_budget = new java.util.HashMap<java.lang.String,java.lang.Double>(2*_map31.size);
                java.lang.String _key32;
                double _val33;
                for (int _i34 = 0; _i34 < _map31.size; ++_i34)
                {
                  _key32 = iprot.readString();
                  _val33 = iprot.readDouble();
                  struct.power_budget.put(_key32, _val33);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.cost_budget = new java.util.HashMap<java.lang.String,java.lang.Double>(2*_map35.size);
                ...
                for (int _i38 = 0; _i38 < _map35.size; ++_i38)
                {
                  ...
                  struct.cost_budget.put(_key36, _val37);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, MissionCostInformation struct) throws org.apache.thrift.TException {
      ...
      if (struct.payload != null) {
        oprot.writeFieldBegin(PAYLOAD_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter39 : struct.payload)
          {
      ...
      if (struct.mass_budget != null) {
        oprot.writeFieldBegin(MASS_BUDGET_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.Double> _iter40 : struct.mass_budget.entrySet())
          {
      ...
      if (struct.power_budget != null) {
        oprot.writeFieldBegin(POWER_BUDGET_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.Double> _iter41 : struct.power_budget.entrySet())
          {
      ...
      if (struct.cost_budget != null) {
        oprot.writeFieldBegin(COST_BUDGET_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.Double> _iter42 : struct.cost_budget.entrySet())
          {
  ...
  private static class MissionCostInformationTupleScheme extends org.apache.thrift.scheme.TupleScheme<MissionCostInformation> {
      ...
      if (struct.isSetPayload()) {
        {
          ...
          for (java.lang.String _iter43 : struct.payload)
          {
      ...
      if (struct.isSetMass_budget()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.Double> _iter44 : struct.mass_budget.entrySet())
          {
      ...
      if (struct.isSetPower_budget()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.Double> _iter45 : struct.power_budget.entrySet())
          {
      ...
      if (struct.isSetCost_budget()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.Double> _iter46 : struct.cost_budget.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, MissionCostInformation struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.payload = new java.util.ArrayList<java.lang.String>(_list47.size);
          java.lang.String _elem48;
          for (int _i49 = 0; _i49 < _list47.size; ++_i49)
          {
            _elem48 = iprot.readString();
            struct.payload.add(_elem48);
          }
        }
        struct.setPayloadIsSet(true);
      }
      ...
      if (incoming.get(6)) {
        {
          ...
          struct.mass_budget = new java.util.HashMap<java.lang.String,java.lang.Double>(2*_map50.size);
          ...
          for (int _i53 = 0; _i53 < _map50.size; ++_i53)
          {
            ...
            struct.mass_budget.put(_key51, _val52);
          }
        }
        struct.setMass_budgetIsSet(true);
      }
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TMap _map54 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.DOUBLE, iprot.readI32());
          struct.power_budget = new java.util.HashMap<java.lang.String,java.lang.Double>(2*_map54.size);
          ...
          for (int _i57 = 0; _i57 < _map54.size; ++_i57)
          {
            ...
            struct.power_budget.put(_key55, _val56);
          }
        }
        struct.setPower_budgetIsSet(true);
      }
      if (incoming.get(8)) {
        {
          ...
          struct.cost_budget = new java.util.HashMap<java.lang.String,java.lang.Double>(2*_map58.size);
          ...
          for (int _i61 = 0; _i61 < _map58.size; ++_i61)
          {
            ...
            struct.cost_budget.put(_key59, _val60);
          }
        }
        struct.setCost_budgetIsSet(true);
      }
