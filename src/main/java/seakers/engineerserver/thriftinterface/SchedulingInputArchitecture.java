...
public class SchedulingInputArchitecture implements org.apache.thrift.TBase<SchedulingInputArchitecture, SchedulingInputArchitecture._Fields>, java.io.Serializable, Cloneable, Comparable<SchedulingInputArchitecture> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("SchedulingInputArchitecture");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new SchedulingInputArchitectureStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new SchedulingInputArchitectureTupleSchemeFactory();

  public int id; // required
  public @org.apache.thrift.annotation.Nullable java.util.List<java.lang.Integer> inputs; // required
  public @org.apache.thrift.annotation.Nullable java.util.List<java.lang.Double> outputs; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(SchedulingInputArchitecture.class, metaDataMap);
  }

  public SchedulingInputArchitecture() {
  }
   ...
   */
  public SchedulingInputArchitecture(SchedulingInputArchitecture other) {
  ...
  public SchedulingInputArchitecture deepCopy() {
    return new SchedulingInputArchitecture(this);
  }
  ...
  public SchedulingInputArchitecture setId(int id) {
    this.id = id;
    setIdIsSet(true);
    return this;
  }
  ...
  public SchedulingInputArchitecture setInputs(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.Integer> inputs) {
    this.inputs = inputs;
    return this;
  }
  ...
  public SchedulingInputArchitecture setOutputs(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.Double> outputs) {
    this.outputs = outputs;
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof SchedulingInputArchitecture)
      return this.equals((SchedulingInputArchitecture)that);
    return false;
  }

  public boolean equals(SchedulingInputArchitecture that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(SchedulingInputArchitecture other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("SchedulingInputArchitecture(");
    boolean first = true;
  ...
  private static class SchedulingInputArchitectureStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public SchedulingInputArchitectureStandardScheme getScheme() {
      return new SchedulingInputArchitectureStandardScheme();
    }
  }

  private static class SchedulingInputArchitectureStandardScheme extends org.apache.thrift.scheme.StandardScheme<SchedulingInputArchitecture> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, SchedulingInputArchitecture struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.inputs = new java.util.ArrayList<java.lang.Integer>(_list32.size);
                int _elem33;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.outputs = new java.util.ArrayList<java.lang.Double>(_list35.size);
                double _elem36;
                for (int _i37 = 0; _i37 < _list35.size; ++_i37)
                {
                  _elem36 = iprot.readDouble();
                  struct.outputs.add(_elem36);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SchedulingInputArchitecture struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.outputs != null) {
        oprot.writeFieldBegin(OUTPUTS_FIELD_DESC);
        {
          ...
          for (double _iter39 : struct.outputs)
          {
  ...
  private static class SchedulingInputArchitectureTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public SchedulingInputArchitectureTupleScheme getScheme() {
      return new SchedulingInputArchitectureTupleScheme();
    }
  }

  private static class SchedulingInputArchitectureTupleScheme extends org.apache.thrift.scheme.TupleScheme<SchedulingInputArchitecture> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, SchedulingInputArchitecture struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetOutputs()) {
        {
          ...
          for (double _iter41 : struct.outputs)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, SchedulingInputArchitecture struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.inputs = new java.util.ArrayList<java.lang.Integer>(_list42.size);
          int _elem43;
          for (int _i44 = 0; _i44 < _list42.size; ++_i44)
          {
            _elem43 = iprot.readI32();
            struct.inputs.add(_elem43);
          }
        }
        struct.setInputsIsSet(true);
      }
      if (incoming.get(2)) {
        {
          ...
          struct.outputs = new java.util.ArrayList<java.lang.Double>(_list45.size);
          double _elem46;
          for (int _i47 = 0; _i47 < _list45.size; ++_i47)
          {
            _elem46 = iprot.readDouble();
            struct.outputs.add(_elem46);
          }
        }
        struct.setOutputsIsSet(true);
      }
