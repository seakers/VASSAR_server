...
public class DiscreteInputArchitecture implements org.apache.thrift.TBase<DiscreteInputArchitecture, DiscreteInputArchitecture._Fields>, java.io.Serializable, Cloneable, Comparable<DiscreteInputArchitecture> {
  ...
  public DiscreteInputArchitecture setInputs(@org.apache.thrift.annotation.Nullable java.util.List<Integer> inputs) {
    this.inputs = inputs;
    return this;
  }
  ...
  public DiscreteInputArchitecture setOutputs(@org.apache.thrift.annotation.Nullable java.util.List<Double> outputs) {
    this.outputs = outputs;
    return this;
  }
