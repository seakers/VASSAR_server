...
public class OperatorTest {
    ...
    public static void main(String[] args){
        ...
        Variation crossover = new search.problems.PartitioningAndAssigning.operators.PartitioningAndAssigningCrossover(crossoverProp, params);
...
//
//            int[] inputs = getIntVariables((search.problems.PartitioningAndAssigning.PartitioningAndAssigningArchitecture) parents[0]);
//            String temp = ppArchInput(inputs, params);
//            System.out.println("Parent: " + temp);
//
//            Solution[] children = mutation.evolve(parents);
//            int[] inputs2 = getIntVariables((search.problems.PartitioningAndAssigning.PartitioningAndAssigningArchitecture) children[0]);
...
//        }
        ...
        for(int i = 0; i < testNum; i++){
            ...
            if(operator.getArity() == 1){
                ...
                inputs = getIntVariables((search.problems.PartitioningAndAssigning.PartitioningAndAssigningArchitecture) children[0]);
                ...
                inputs = getIntVariables((search.problems.PartitioningAndAssigning.PartitioningAndAssigningArchitecture) parents[1]);
                temp = ppArchInput(inputs, params);
                ...
                inputs = getIntVariables((search.problems.PartitioningAndAssigning.PartitioningAndAssigningArchitecture) children[1]);
                temp = ppArchInput(inputs, params);
